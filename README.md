...
Interactive Windows Graphics Capture source picking/GPU texture capture, Media Foundation H.264 frame submission/output, real Opus, production window controls, and production-grade adaptive media feedback are later stages.
